...
const MealHistory = () => {
  ...
  const fetchData = async (uid: string) => {
    try {
      ...
      setLoading(false); // To make sure loading state is updated
    }
  };
          ...
          {Object.keys(groupedMeals).length > 0 ? (
            ...
            <div className="mt-8 ml-9 mr-9">
              ...
              {loading ? (
                ...
                <p className="text-white text-2xl flex mt-5 justify-center">
                  There is no meal history data available.
                </p>
              )}
            </div>
          )}
